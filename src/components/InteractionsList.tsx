...
> = {
  ...
  MEETING: {
    label: "Reunión",
    icon: Users,
    color: "text-purple-700 bg-purple-50 ring-purple-700/10",
  },
  NOTE: {
    label: "Nota",
    icon: FileText,
              ...
              filtered.map((interaction) => {
                ...
                return (
                  <tr
                    ...
                    onClick={() =>
                      (window.location.href = `/customers/${interaction.customerId}`)
                    }
                  >
                    <td className="whitespace-nowrap py-4 pl-4 pr-3 sm:pl-6">
                      <span
                        className={`inline-flex items-center gap-1.5 rounded-full px-2 py-1 text-xs font-medium ring-1 ring-inset ${config.color}`}
                      >
